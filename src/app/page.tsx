        ...
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <div className="gap-2 flex justify-between">
            ...
            <BlurFade delay={BLUR_FADE_DELAY}>
              <Avatar className="size-28 border-4">
      ...
      <section id="projects">
        <div className="space-y-6 w-full py-6">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[800px] mx-auto">
            {DATA.projects
              .filter((project) => project.featured) // Filter featured projects
              .map((project, id) => (
                <BlurFade
                  key={project.title}
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  {DATA.hackathons.length}+ hackathons. People from across the
                  country collaborated to build incredible projects in just a
                  few days. It was inspiring to see passion turn ideas into
                  reality.
                </p>
              </div>
            </div>
